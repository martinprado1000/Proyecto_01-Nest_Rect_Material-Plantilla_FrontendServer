...
import { MenuContent, MenuContentCompact } from "../common/MenuContent";
  ...
  return (
    <Box sx={{ display: "flex" }}>
      ...
      <Drawer variant="permanent" open={open}>
        ...
        {open ? <MenuContent /> : <MenuContentCompact />}

        {open ? <CardAlert /> : <></>}

        {open ? <UserStackContainer responsive={false} /> : <UserStackContainer responsive={true} />}
