        ...
        <Card variant="outlined" sx={{ overflowY: "auto", maxHeight: "100%" }}>
          ...
          >
            <FormControl>
              ...
              />
              {errors.name && (
                <Typography sx={{ color:"#dc3545" }}>{errors.name.message}</Typography>
              )}
            </FormControl>
            <FormControl>
              ...
              />
              {errors.lastname && (
                <Typography sx={{ color:"#dc3545" }}>{errors.lastname.message}</Typography>
              )}
            </FormControl>
            <FormControl>
            ...
            <FormControl>
              ...
              />
              {errors.password && (
                <Typography sx={{ color:"#dc3545" }}>{errors.password.message}</Typography>
              )}
            </FormControl>
            <FormControl>
              ...
              {errors.confirmPassword && (
                <Typography sx={{ color:"#dc3545" }}>{errors.confirmPassword.message}</Typography>
              )}
            </FormControl>
            {/* <FormControlLabel
